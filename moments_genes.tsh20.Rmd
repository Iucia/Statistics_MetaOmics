...
moments_metab.tsh20_otus %>%
  ...
  ggpubr::stat_regline_equation(formula = y ~ poly(x,2),  label.x.npc = "left", label.y.npc = "top") +
  ggpubr::stat_cor(formula = y ~ poly(x,2), label.x.npc = "middle", label.y.npc = "bottom") +
  theme_bw() +
