...
library(patchwork)
(richness.metab | dominance.metab) / (rarity.metab | evenness.metab)
...
(richness.metag | dominance.metag) / (rarity.metag | evenness.metag)
...
(richness.metat | dominance.metat) / (rarity.metat | evenness.metat)
